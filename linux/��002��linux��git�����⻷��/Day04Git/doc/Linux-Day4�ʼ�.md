...
> ijeff@Rock:~/Desktop/python2019$ git config --global user.email "18870424327@163.com"		
>     #配置github上的邮箱
> ijeff@Rock:~/Desktop/python2019$ git config --global user.name " Feier-4869"				
>     #配置github上的用户名
> ijeff@Rock:~/Desktop/python2019$ git commit -m "create a new file and init"	
...
> ```Python
> 演示命令：
> ijeff@Rock:~/Desktop/python2019$ ssh-keygen  -t   rsa  -C    "188700424327@163.com"      #生成ssh key
